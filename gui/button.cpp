...
GUI_Button::GUI_Button(int x, int y, int width, int height, Color bg_color, Color fg_color, TTF_Font* font, const std::string& text, std::function<void(void*) > callback) {
